...
{
    public partial class frmInsertRoomPlan : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            edtStartDate.Text = Convert.ToDateTime(NgayBD).ToString("dd/MM/yyyy");
            edtEndDate.Text = Convert.ToDateTime(NgayKT).ToString("dd/MM/yyyy");
            tbLocation.Text = tenphong;
        }
    }
}