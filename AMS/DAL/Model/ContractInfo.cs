...

{
    ...
    public class ContractInfo
    {
        ...
        public string RateReasonCode { get; set; }
        public int TravelAgentCode { get; set; } //bigint
        ...
        public string SlipsStatus { get; set; }
        public bool RoomTaxPostedFlag { get; set; }
        public bool NoShowFlag { get; set; }
        public bool EarlyArrivalFlag { get; set; }
        public bool WalkInFlag { get; set; }
        ...
        public string SlipsCurrencyCode { get; set; }
        public int ExtraBed { get; set; }
        public bool RoomChargeToMasterFlag { get; set; }
        public double SlipsExRate { get; set; } //[numeric](18, 2)
        public int NumGuestBF { get; set; }
        public string LastName { get; set; }
        public string FirstName { get; set; }
        public string TitleCodeM { get; set; }
        public string TelNumM { get; set; }
        public string FaxNumM { get; set; }
        ...
        public double SlipsBalance { get; set; } //[numeric] (18, 2)
